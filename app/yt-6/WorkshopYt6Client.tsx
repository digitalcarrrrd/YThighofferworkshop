...
export default function WorkshopYt6Client() {
  ...
  const handleSubmitProof = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        const res = await fetch("/api/yt6-submit", {
          method: "POST",
        ...
        console.warn("CRM workflow note:", err);
      }
              ...
              {modalStep === 1 ? (
                <form onSubmit={handleSubmitProof} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div 
                      ...
                      className="border-2 border-dashed border-slate-600 hover:border-green-500 bg-[#07111F] p-3.5 rounded-xl text-center cursor-pointer transition-colors"
                    >
                      <input 
                        type="file" 
                        ref={fileInputRef} 
                      ...
                      {screenshotBase64 ? (
                        ...
                        <div>
                          ...
                          <p className="text-xs font-bold text-white">Tap to upload receipt (Optional)</p>
                          <p className="text-[10px] text-slate-400">Yahan attach karein ya direct WhatsApp chat me send karein</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 text-white font-black text-base py-4 rounded-xl shadow-xl transition-all active:scale-98 disabled:opacity-70 flex items-center justify-center gap-2"
                  >
                ...
                <div className="text-center py-6 px-2 space-y-4">
                  ...
                  <p className="text-xs sm:text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
                    Aap ki details receive ho chuki hain. Payment verify karke hamari team aapko confirmed Google Meet link aur WhatsApp group access provide karegi.
                  </p>
