...
export default function WorkshopYt6Client() {
  ...
  // Announcement bar timer & interactive states
    ...
    try {
      ...
      if (typeof (window as any).fbq === "function") {
        (window as any).fbq("track", "CompleteRegistration", {
          value: 1999,
          currency: "PKR",
          content_name: "YouTube Empire Builders Workshop 6",
        });
      }
  ...
  return (
    <div className="yt6-body">
      
      {/* ANNOUNCEMENT BAR */}
      <div className="yt6-announcement-bar">
        {isAfterSeven ? (
      ...
      {/* HERO SECTION */}
      <header className="yt6-hero-section">
        <div className="yt6-container">
          <div className="yt6-pill-badge">
            Pakistan Ke 4-Year Bachelor&apos;s Students Ke Liye — Past. Present. Future.
          </div>

          <div className="yt6-hero-title">
            <span className="yt6-hero-line-white">Aapke Class Mein Ek Banda</span>
            <span className="yt6-hero-line-white">ChatGPT Se Exam Cheat Kar Raha Hai.</span>
            
            <span className="yt6-hero-line-amber">Ek Banda Wahi ChatGPT Se</span>
            <span className="yt6-hero-line-green">Dollar Kama Raha Hai.</span>
            
            <span className="yt6-hero-line-subwhite">Dono Ek Hi University Mein Hain.</span>
            <span className="yt6-hero-line-subwhite">Dono Ka Baap Ek Jaisi Fees Bhar Raha Hai.</span>
            
            <span className="yt6-hero-line-subgreen">Fark Sirf Ek Decision Ka Hai.</span>
          </div>

          <p className="yt6-hero-subtitle">
          ...
          <div className="yt6-stats-grid">
            <div className="yt6-stat-card card-red">
              <div className="yt6-stat-label">4 Saal Degree Baad</div>
              <div className="yt6-stat-val">PKR 25,000</div>
              <div className="yt6-stat-sub">Average pehli salary Pakistan</div>
            </div>

            <div className="yt6-stat-card card-amber">
              <div className="yt6-stat-label">Wahi AI. Alag Use.</div>
              <div className="yt6-stat-val">60 Min/Video</div>
              <div className="yt6-stat-sub">Script → Voice → Upload → Dollar</div>
            </div>

            <div className="yt6-stat-card card-green">
              <div className="yt6-stat-label">YouTube Income</div>
              <div className="yt6-stat-val">$500/month</div>
              <div className="yt6-stat-sub">= PKR 1,39,000 — Sote Waqt Bhi</div>
            </div>
          </div>

          {/* Hero CTA */}
          <div className="max-w-xl mx-auto">
            <button onClick={openPayModal} className="yt6-cta-btn">
      ...
      <section className="yt6-narrative-section">
        <div className="yt6-container">
          ...
          <div className="yt6-story-box">
            ...
            <div className="yt6-story-divider" />

            <div className="yt6-story-student-tag tag-bilal">Pehla banda — Bilal</div>
            <p>
            ...
            <div className="yt6-story-student-tag tag-saad">Doosra banda — Saad</div>
            <p>
      ...
      <section className="yt6-light-section">
        <div className="yt6-container">
          ...
          <div className="yt6-compare-grid">
            {/* Left Column (Galat Use) */}
            <div className="yt6-compare-col col-wrong">
              <h3>❌ Galat Use (Bilal Path)</h3>
              <ul className="yt6-compare-list">
                <li className="yt6-compare-item">
              ...
              <div className="yt6-compare-footer text-red-700">
            ...
            <div className="yt6-compare-col col-right">
              ...
              <div className="yt6-compare-footer text-green-700">
      ...
      <section className="yt6-dark-section">
        <div className="yt6-container">
          <div className="text-center mb-10">
          ...
          {/* Degree stats */}
          <div className="yt6-numbers-grid">
            <div className="yt6-number-card">
              <div className="yt6-number-val val-red">4,00,000+</div>
              <div className="yt6-number-title">Graduates Har Saal</div>
              <div className="yt6-number-sub">Har saal. Ek hi market mein.</div>
            </div>
            <div className="yt6-number-card">
              <div className="yt6-number-val val-red">30%+</div>
              <div className="yt6-number-title">Graduate Unemployment</div>
              <div className="yt6-number-sub">Official figure. Real shayad zyada.</div>
            </div>
            <div className="yt6-number-card">
              <div className="yt6-number-val val-red">PKR 25,000</div>
              <div className="yt6-number-title">Average Starting Salary</div>
              <div className="yt6-number-sub">4 saal baad. Lakhon invest karke.</div>
            </div>
            <div className="yt6-number-card">
              <div className="yt6-number-val val-amber">6-8 Mahine</div>
              <div className="yt6-number-title">Job Hunt Duration</div>
              <div className="yt6-number-sub">CV bhejne se pehli job tak.</div>
            </div>
            <div className="yt6-number-card">
              <div className="yt6-number-val val-amber">20%+</div>
              <div className="yt6-number-title">Annual Inflation</div>
              <div className="yt6-number-sub">Aapki salary is se tez nahi badhti.</div>
            </div>
            <div className="yt6-number-card">
              <div className="yt6-number-val val-red">PKR 833</div>
              <div className="yt6-number-title">Per Din ROI</div>
              <div className="yt6-number-sub">PKR 25K/30 days degree daily return.</div>
            </div>
          </div>
          ...
          <div className="yt6-numbers-grid">
            <div className="yt6-number-card">
              <div className="yt6-number-val val-green">$70 Billion+</div>
              <div className="yt6-number-title">YouTube Creators Payout</div>
              <div className="yt6-number-sub">Pakistan ka hissa abhi bhi available hai.</div>
            </div>
            <div className="yt6-number-card">
              <div className="yt6-number-val val-green">$500/Month</div>
              <div className="yt6-number-title">= PKR 1,39,000</div>
              <div className="yt6-number-sub">Ek average channel. Sote waqt.</div>
            </div>
            <div className="yt6-number-card">
              <div className="yt6-number-val val-green">40M+</div>
              <div className="yt6-number-title">YouTube Users Pakistan</div>
              <div className="yt6-number-sub">Audience exist karti hai. Creator kahan hai?</div>
            </div>
          </div>

          {/* Comparison Table */}
          <div className="yt6-brutal-table-wrap">
            <table className="yt6-brutal-table">
              <thead>
                <tr>
      ...
      <section className="yt6-light-section">
        <div className="yt6-container">
          ...
          <div className="yt6-steps-grid">
            <div className="yt6-step-card">
              <div className="yt6-step-num">1</div>
              <div className="yt6-step-content">
            ...
            <div className="yt6-step-card">
              <div className="yt6-step-num">2</div>
              <div className="yt6-step-content">
            ...
            <div className="yt6-step-card">
              <div className="yt6-step-num">3</div>
              <div className="yt6-step-content">
            ...
            <div className="yt6-step-card">
              <div className="yt6-step-num">4</div>
              <div className="yt6-step-content">
            ...
            <div className="yt6-step-card">
              <div className="yt6-step-num">5</div>
              <div className="yt6-step-content">
            ...
            <div className="yt6-step-card">
              <div className="yt6-step-num">6</div>
              <div className="yt6-step-content">
            ...
            <div className="yt6-step-card">
              <div className="yt6-step-num">7</div>
              <div className="yt6-step-content">
      ...
      <section className="yt6-dark-section">
        <div className="yt6-container">
          ...
          <div className="yt6-year-tabs">
            {[
              ...
              <button
                ...
                className={`yt6-year-btn ${selectedYear === tab.id ? "active" : ""}`}
              >
                {tab.label}
              </button>
            ))}
          ...
          {/* Dynamic Content */}
          <div className="yt6-year-content-box">
            {selectedYear === "1st" && (
      ...
      <section className="yt6-narrative-section">
        <div className="yt6-container">
          ...
          <div className="max-w-xl mx-auto bg-gradient-to-b from-[#0F1D32] to-[#040A12] border-2 border-green-500 p-8 rounded-2xl text-center shadow-2xl">
            ...
            <button onClick={openPayModal} className="yt6-cta-btn w-full">
      ...
      {/* FLOATING MOBILE CTA */}
      <div className={`yt6-sticky-mobile-cta ${floatingVisible ? "visible" : ""}`}>
        <div className="yt6-sticky-price">
