      ...
      try {
          ...
          body: JSON.stringify({
            ...
            customFields: [
              ...
              ...(process.env.GHL_LANDING_PAGE_FIELD_KEY
                ? [{ key: process.env.GHL_LANDING_PAGE_FIELD_KEY, field_value: "/yt-7" }]
                : []),
            ],
          }),
        });
        ...
        if (contactId && pipelineId && stageId) {
          const oppPayload = {
            ...
            locationId,
            contactId,
            name: `${fullName.trim()} – 4 Saal Degree YouTube Workshop (PKR 1,999)`,
