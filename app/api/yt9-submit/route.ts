      ...
      try {
          ...
          body: JSON.stringify({
            ...
            customFields: [
              ...
              ...(process.env.GHL_LANDING_PAGE_FIELD_KEY
                ? [{ key: process.env.GHL_LANDING_PAGE_FIELD_KEY, field_value: "/yt9" }]
                : []),
            ],
          }),
        });
        ...
        if (contactId && pipelineId && stageId) {
          const oppPayload = {
            ...
            locationId,
            contactId,
            name: `${fullName.trim()} – Digital Zameen Workshop 9 (PKR 2,999)`,
