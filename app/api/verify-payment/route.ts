    ...
    if (contactId && email) {
      const verifiedEmailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0b100c; color: #ffffff; padding: 30px; border-radius: 16px; border: 1px solid #22c55e;">
          ...
          <a href="https://wa.me/923296158206?text=Salam%20Abrar%20Bhai!%20Mera%20payment%20verify%20ho%20gaya%20hai,%20please%20add%20me%20to%20the%20VIP%20WhatsApp%20group" style="color: #22c55e; font-weight: bold;">Click Here to Connect with Abrar on WhatsApp →</a></p>
